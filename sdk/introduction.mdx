...
The first step to using Massive Network is making sure you have been approved to use our SDK. If you haven't done so already, [create an account](https://www.joinmassive.com/create-account-sdk) and if you have signed up but do not have credentials email support@joinmassive.com.
