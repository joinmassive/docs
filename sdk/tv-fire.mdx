---
title: 'FireOS'
description: 'Integrate Massive SDK into your FireOS application with this guide.'
---
...
|                 |                                                      |                     |
| ----------------| ---------------------------------------------------- | ------------------- |
| <Icon icon="Android" iconType="solid" /> | Sample Application (Android / FireOS) | [Download](https://downloads.joinmassive.com/sdk/android/1.0.0/Massive-SampleApp.zip) |
...
3. Copy the [API token](#api-token) from the top of this page.
...
Massive SDK API token is available at the [top](#api-token) of this page and in your [Profile](https://partners.joinmassive.com/profile).
