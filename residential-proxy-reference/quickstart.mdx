...
| API Key     | {userContext.api_key ?? 'API KEY'} |
| HTTPS Port  | 65535 |
| HTTP Port   | 65534 |
| SOCKS5 Port | 65533 |
...
```bash
curl --proxy https://network.joinmassive.com:65535 --proxy-user {userContext.proxy_username ?? 'PROXY_USERNAME'}:API_KEY https://cloudflare.com/cdn-cgi/trace
```
