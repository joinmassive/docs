...
icon: earth-americas
iconType: light
description: Search, chat, and browse from anywhere.
---

import Country from '/snippets/whitelabel/search/country.mdx';
import Subdivision from '/snippets/whitelabel/ai/subdivision.mdx';
...
<AccordionGroup>
  <Accordion icon='terminal' title='View subdivision example'>
    <Subdivision />
  </Accordion>

  <Accordion icon='terminal' title='View city example'>
    <City />
  </Accordion>
</AccordionGroup>
