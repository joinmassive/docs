...
| `521`       | No Upstream Proxy Available      | No upstream proxy servers have sufficient capacity to handle requests for the specified geographic location or ASN. This may occur when targeting regions with limited node availability or when using sticky sessions with strict geographic constraints. Try retrying the request, relaxing geographic constraints, or using flexible session mode |